...
const UserSchema = new Schema<IUser>({
  ...
  phone: { type: String, required: function() { return this.role === 'student'; } },
  admission: { type: String, required: function() { return this.role === 'student'; } },
  email: { type: String, required: true, unique: true },
  course: { type: String, required: true },
  level: { type: String, required: function() { return this.role === 'student'; } },
